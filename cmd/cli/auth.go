...
func doAuth() error {
	...
	err = copyFilefromTemplate("templates/mail/password-reset.html.tmpl", cel.RootPath+"/mail/password-reset.html.tmpl")
	if err != nil {
		exitGracefully(err)
	}

	err = copyFilefromTemplate("templates/mail/password-reset.plain.tmpl", cel.RootPath+"/mail/password-reset.plain.tmpl")
	if err != nil {
		exitGracefully(err)
	}
	...
	color.Yellow("    - users, token models created")
	color.Yellow("    - auth middleware created")
	color.Yellow("    - auth middleware created")
	color.Yellow("Do not forget to add users and token models in data/models.go and add appropriated middleware to your routes!")
